...
"C:\Program Files\IAR Systems\Embedded Workbench 5.4\common\bin\cspybat" "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\bin\avrproc.dll" "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\bin\avrsim.dll"  %1 --plugin "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\bin\<libsupport_plugin>" --backend -B "--cpu=m16" "--enhanced_core" "-p" "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\Config\iom16.ddf" "--eeprom_size" "512" "-d" "sim" 
